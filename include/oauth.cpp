...
OAuth::OAuth(std::string oauth_uid_in, std::string redirect_uri_in, std::shared_ptr<Rest> rest_interface_in)
...
OAuth &OAuth::operator=(const OAuth &other) {
...
std::string OAuth::generate_authentication_url() {
...
bool OAuth::accept_authentication_code(std::string code) {
    bool valid = false;
...
std::string OAuth::get_authentication_code() {
    return this->authentication_code;
}

std::string OAuth::get_access_token() {
    return this->access_token;
}

OAuthStatus OAuth::generate_tokens() {
    // Skip if valid.
...
std::string OAuth::get_OAuth_UID() {
    return this->oauth_uid;
}
OAuthStatus OAuth::get_status() {
...
bool OAuth::load_refresh_token_from_disk() {
    bool loaded = false;
...
void OAuth::save_refresh_token_to_disk() {
...
bool OAuth::refresh_token_valid() {
    bool valid = false;
...
bool OAuth::parsed_auth_json_is_valid(rapidjson::Document& auth_result) {
